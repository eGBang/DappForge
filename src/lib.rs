...
#[derive(Debug)]
pub struct DappForgeProcessor {
    verbose: bool,
    processed_count: usize,
}

impl DappForgeProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting DappForge processing");
    
    let mut processor = DappForgeProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = DappForgeProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = DappForgeProcessor::new(false);
